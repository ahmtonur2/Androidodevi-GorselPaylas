...
public class FeedRecyclerAdapter extends RecyclerView.Adapter<FeedRecyclerAdapter.PostHolder> {
    ...
    //ViewHolder xml ile baglama islemleri olusturunca ne yapacaklarin
    ...
    @Override//ViewHolder baglaninca ne yapacaklarin
    ...
    //asagıda recyclerda kaç tane row olacagını belirtıyoruz
